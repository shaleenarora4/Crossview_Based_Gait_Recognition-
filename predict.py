...
if __name__ == '__main__':
    ...
    model = tf.keras.models.load_model('all_angle.h5') #Returns a Keras model instance.To use the same trained model for further testing you can simply load the hdf5 file and use it for the prediction of different data.
